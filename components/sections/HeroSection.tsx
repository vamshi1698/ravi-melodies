    ...
    <section id="hero" className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-20 px-4 sm:px-6">
        ...
        >
          <motion.p
            ...
            className="text-gold/80 uppercase tracking-[0.2em] sm:tracking-[0.3em] text-xs sm:text-sm mb-3 md:mb-4"
          >
            Events & Orchestra
          </motion.p>
          ...
          <h1 className="relative">
            <motion.span
              ...
              className="block text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-display font-bold tracking-tight"
            >
            ...
            <motion.span
              ...
              className="block text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-display font-bold text-gradient-gold mt-1 md:mt-2"
            >
              MELODIES
            </motion.span>
          </h1>
          ...
          <motion.p
            ...
            className="text-white/70 text-base sm:text-lg md:text-xl mt-4 sm:mt-6 mb-6 sm:mb-8 md:mb-10 font-light px-4"
          >
          ...
          >
            <button
              ...
              className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-gold to-gold-light text-matte-black font-semibold rounded-full flex items-center justify-center gap-2 sm:gap-3 hover:shadow-gold transition-all duration-500 magnetic-button text-sm sm:text-base"
            >
              <span>Book on WhatsApp</span>
              <svg className="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button
              onClick={handleCall}
              className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 border-2 border-gold/50 text-gold font-semibold rounded-full flex items-center justify-center gap-2 sm:gap-3 hover:bg-gold/10 hover:border-gold transition-all duration-500 magnetic-button text-sm sm:text-base"
            >
        ...
        <motion.button
          ...
          animate={{ opacity: 1 }}
          transition={{ delay: 2 }}
          className="absolute bottom-16 sm:bottom-20 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/50 hover:text-white/80 transition-colors cursor-pointer group px-4"
          onClick={handleScrollToStory}
        >
          <span className="text-xs uppercase tracking-widest hidden sm:block">Watch Performances</span>
          <Play size={20} className="sm:w-6 sm:h-6 group-hover:scale-110 transition-transform" />
        </motion.button>
      </div>
      ...
      >
        <motion.div
          ...
          className="w-5 h-8 sm:w-6 sm:h-10 border-2 border-white/30 rounded-full flex items-start justify-center p-1"
        >
          <motion.div
            animate={{ y: [0, 10, 0], opacity: [1, 0.3, 1] }}
            transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
            className="w-1 h-1.5 sm:w-1.5 sm:h-1.5 bg-gold rounded-full"
          />
        </motion.div>
      </motion.div>
    </section>
